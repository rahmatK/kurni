...
<body>
    ...
    <main id="content" role="main">
        <link data-turbolinks-track="true" href="css/application.css" media="all" rel="stylesheet" />
        <link data-turbolinks-track="true" href="css/signin.css" media="all" rel="stylesheet" />
        <section class="loginwrap">
            <div class="bgoverlay">
                <div class="content container">
                    ...
                    <div class="subtitle">Not a member?<a href="signup.php">Sign up</a>
                    </div>
                    <div class="col-md-6 form">
                        <div class="col-md-12 form-content">
                            <form accept-charset="UTF-8" action="signincheck.php" class="new_user" id="new_user" method="post">
                                ...
                                <div class="col-md-12 text-left">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input autofocus="autofocus" class="form-control" data-parsley-trigger="change" id="user_email" name="email" placeholder="Email Address" type="email" value="" />
                                    </div>
                                </div>
                                <div class="col-md-12 text-left">
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input autocomplete="off" class="form-control" id="user_password" name="password" placeholder="Password" type="password" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 text-right"><a href="javascript:void(0)"><a class="" href="/users/password/new">Forgot your password?</a></a>
                                </div>
                                <div class="col-md-12 text-left">
                                    <div class="form-group">
                                        <input class="def-button" name="commit" type="submit" value="Sign in" />
                                    </div>
                                </div>
                            </form>
                        </div>
