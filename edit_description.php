            ...
            <div class="container content">
                    ...
                    <div class="left-list">
                        <ul class="left-ul">
                            ...
                            <a href="edit_description.php?idboat=<?php echo "$_GET[idboat]";  ?>">
                                <li class="left-li active">Description &amp; Pricing</li>
                            </a>
                ...
                <div class="col-md-8 col-sm-12 col-xs-12 contentright">Your list is 33.33% complete
                    ...
                    <div class="boat-details">
                        ...
                        <form accept-charset="UTF-8" action="/boats/52" class="edit_boat" id="edit_boat_52" method="post">
                            ...
                            <div class="col-md-12">
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" cols="20" id="boat_description" name="boat[description]" placeholder="Description" rows="20">
                                    </textarea>
                                </div>
                            </div>
